...
public class MessageResponse {
    ...
    public String getDisplayText() {
        ...
        switch (category){
            ...
            case INSTRUCTOR_EMAIL:return "Instructor's E-mail address is "+getString("instructor_email");
            ...
            case LAB_WEIGHTAGE:
            case QUIZZ_WEIGHTAGE: return getString("activity")+" weightage is "+getString("weightage");
