...
public enum Category {
    ...
    INSTRUCTOR_CONTACT(3, Arrays.asList(Suggestion.EMAIL_INSTRUCTOR,Suggestion.INSTRUCTOR_NAME,Suggestion.INSTRUCTOR_PHONE_NO,
            Suggestion.INSTRUCTOR_OFFICE_HOURS,Suggestion.INSTRUCTOR_OFFICE_LOCATION)),
    ...
    COURSE_WEBSITE(12, Arrays.asList(Suggestion.CLASS_TIMINGS,  Suggestion.CLASS_LOCATION, Suggestion.INSTRUCTOR_CONTACT,
            Suggestion.REFERENCE_MATERIALS)),
    COURSE_GRADING(21,Arrays.asList(Suggestion.MID_TERM_DUE_DATE, Suggestion.PROJECT_DUE_DATE, Suggestion.COURSE_WEBSITE,
            Suggestion.REFERENCE_MATERIALS, Suggestion.FINAL_EXAM_DUE_DATE)),
